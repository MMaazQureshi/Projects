# Finds Minimum no. of substrings required to make a string
This Algorithm is Written by Me(Muhammad Maaz Qureshi) for an online algorithm test feel free to use any issues spotted/resolve are welcomed
